...
export const MAP_SATELLITE_TILES_URL = import.meta.env.VITE_MAP_SATELLITE_TILES_URL
  ?? (EXTERNAL_NETWORK_ALLOWED ? 'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}' : '');
export const MAP_VECTOR_STYLE_URL = import.meta.env.VITE_MAP_VECTOR_STYLE_URL
